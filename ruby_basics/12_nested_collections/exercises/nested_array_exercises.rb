def blank_seating_chart(number_of_rows, seats_per_row)
  ...
  seating = Array.new(number_of_rows) {Array.new(seats_per_row)}
end
...
def find_favorite(array_of_hash_objects)
  ...
  # ]
  favorite_hash = array_of_hash_objects.find { |hash| hash[:is_my_favorite?] == true }
  return favorite_hash if favorite_hash
